...
// OSM lags behind reopenings — Sofia's tram 6 was carrying service through
// Надежда while its ways still said construction=tram, which tore a 440 m hole
// in the line. The road graph has accepted highway=construction from the start
// for the same reason; the GTFS shape is the evidence that service runs there.
